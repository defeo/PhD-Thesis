...
\end{equation}
are called a \emph{basis} of $\Lambda$.
...
The minimal polynomial of the modular function $j(\ell\tau)$ is called
the \index{th modular polynomial}\emph{$\ell$-th modular polynomial},
it is denoted by
...
elliptic curves $\ell$-isogenous to $E$.
...
are often preferred to $\Modpol_\ell$, as for example Atkins'
