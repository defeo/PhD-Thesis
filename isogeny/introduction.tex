...
\pdfmargincomment[color=red,subject=rev2]{Let's be less misterious.}
...
\pdfmargincomment{A little more crypto here.}
...
\begin{remark}
  ...
  \pdfmargincomment[color=red,subject=rev2]{"When the isogenous curve
    is of no interest" was really unuseful.}  It is sometimes more
