...
Schoof-Elkies-Atkin algorithm~\cite{atkin88,elkies98,schoof95} one
factors the modular polynomial $\Modpol_\ell$ to obtain $j$-invariants
of curves $\ell$-isogenous to $E$. Using the partial derivatives of
...
\begin{nota}
  ...
  \pdfmargincomment{More precise remark on what we were not able to
    do.}  However, in the cases $p=2,3$, Elkies formulas yield a curve
  ...
  \hyperref[alg:bmss]{\alg{BMSS}}. We did not attempt to modify the
