...
Gunji shows the following proposition and gives formulas to compute
the $p$-torsion points.

\begin{proposition}
  \label{th:gunji}
  Let $c=\sqrt[p-1]{H_E}$; then, the $p$-torsion points of $E$ are
  defined in $\F_q[c]$ and their abscissas are defined in $\F_q[c^2]$.
\end{proposition}

% todo ? Gunji's formulas ?
