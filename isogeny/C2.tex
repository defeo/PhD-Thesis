...
\begin{proposition}
  ...
  \end{equation}
  \pdfmargincomment{The "étale" property is from the original
...
\pdfmargincomment{"Kummer surface" -> "Kummer variety".}
...
\pdfmargincomment[color=red,subject=rev2]{y coordinates are not needed
