...
\hyperref[alg:le-si]{\alg{Lercier-Sirvent}}. All the experiments were
run on four dual-core Intel Xeon E5430 (2.6GHz), eventually using the
parallelized version of the algorithm.
...
\pdfmargincomment{Added some blabla on Teske's cryptosystem.}
...
\hyperref[alg:le-si]{\alg{Lercier-Sirvent}}. Table~\ref{tab:ls} shows
...
\begin{table}[ht]
  ...
  \begin{tabular}{r r r r r r}
    ...
    \hline
  \end{tabular}
  \caption{Comparative timings for the phases of \hyperref[alg:le-si]{\alg{Lercier-Sirvent}} for curves over $\F_{5^{43}}$.}
  \label{tab:ls}
\end{table}
...
\hyperref[alg:le-si]{\alg{Lercier-Sirvent}} (compare
...
\begin{figure}
  ...
  \caption{Timings for \hyperref[alg:le-si]{\alg{Lercier-Sirvent}} for
