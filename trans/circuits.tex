...
\pdfmargincomment{Added parentheses in the definition of the bases,
...
\pdfmargincomment{I explain why I postponed the elegant proof.}  In
...
\end{lemma}
\begin{proof}
  \pdfmargincomment{Patched proof, now it is correct!}
...
\begin{remark}
  ...
  \pdfmargincomment{Dropped comment about quantum computing: it is
    more complicated than that (and I didn't want to develop it in the
