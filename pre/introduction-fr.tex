...
Dans le cas spécifique des tours d'Artin-Schreier, il n'y a as
...
Dans ce document nous enquêtons plus en détail les rapports entre la
...
des idéaux zéro-dimensionnels et la représentation univariée
...
algorithmes asymptotiquement bons pour les tours d'Artin-Schreier (fruit d'une autre collaboration avec Schost).
