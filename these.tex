...
\newcommand{\alg}[1]{#1}%\sffamily{#1}}  % la police des algorithmes
...
\makechapterstyle{defeo}{%  needs graphicx package
  ...
  \renewcommand*{\chapnumfont}{\chapnamefont\bfseries}
  \renewcommand*{\chaptitlefont}{\normalfont\large\scshape\bfseries\ifthenelse{\isodd{\thepage}}{\raggedright}{\raggedleft}}
...
\makeheadstyles{defeo}{%
  ...
  \chapterstyle{defeo}%
  %\setsubsecheadstyle{\sethangfrom{\noindent ####1}\normalfont\slshape\memRTLraggedright}%
