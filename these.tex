...
%\DeclareMathOperator{\diam}{diam}  % size, depth and diameter of a circuit
\DeclareMathOperator{\hub}{\&}  % a hub node
\DeclareMathOperator{\id}{id}  % identity
\DeclareMathOperator{\proc}{\textcolor{blue}{proc}}  % proc keyword in transAL
\DeclareMathOperator{\return}{\textcolor{blue}{return}}  % return keyword in transAL
\DeclareMathOperator{\talif}{\textcolor{blue}{if}}  % if keyword in transAL
\DeclareMathOperator{\talelse}{\textcolor{blue}{else}}  % else keyword in transAL
